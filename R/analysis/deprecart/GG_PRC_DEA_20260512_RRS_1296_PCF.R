...
### Annoate
metadata<-openxlsx::read.xlsx("./projects/20260512_RRS_1296_PCF_Phospho2///sample_sheets/sample_sheet_anno_flt.xlsx",sheet = 1)
rownames(metadata)<-metadata$sample_id

gg_se<-mq_listmq_list$gg_se
gg_se<-gg_se[,gg_se$sample_id%in%metadata$original_id]
