...
#'
####===================================####
dataset  = '20260512_RRS_1296PCF' # - Name of the dataset that is going to be analysed.
analysis = paste0('enhanced_volcano_chromsome/',Sys.Date()) # - Name of the analysis e.g Marker Identification
library("proteoLab")
library("dplyr")
library("patchwork")

gg_se<-readRDS("./projects/20260709_RRS_1296PCF/rds/gg_se_id_2_preproc.rds")
...
indexp<-rownames(tt)%in% chr7p_set$gene_symbol
...
indexq<-rownames(tt) %in% chr7q_set$gene_symbol
