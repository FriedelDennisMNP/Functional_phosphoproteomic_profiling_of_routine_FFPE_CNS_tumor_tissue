...
ttresult<-openxlsx::read.xlsx("./output/20260813_RRS_1296_PCF_Phospho/PTM_PRC_DEA/2026-08-19/TopTable_WT_AMP.xlsx")
...
dea_dc_act<-dea_dc_kinacts$ProtMapper
