...
dataset = paste0('/Figure1_PhosProt/')
library("rip")
library("proteoLab")
...
proc_wp<-readRDS("./output/20260817_RR1296_PCF/WP_PRC_DEA/2026-08-20/ms_se_prc.rds")
...
figure_1A<-purrr::map(names(proc_list),function(raw_ms_name){
  ...
  fig1_panA <-
    ...
    ggplot2::labs(y = paste0("Number of confidently idenitfied ",plottext), x = "Sample") +
...
ggsave(plot = figure_1A[[1]],filename = save_here(object_name = "Figure1A.pdf"),width = 7,height = 7)
ggsave(plot = figure_1A[[2]],filename = save_here(object_name = "Supplemental_Figure1A.pdf"),width = 7,height = 7)
...
ggsave(plot = figure_1B[[1]],filename = save_here(object_name = "Figure1B.pdf"),width = 10,height = 7)
ggsave(plot = figure_1B[[2]],filename = save_here(object_name = "Supplemental_Figure1B.pdf"),width = 10,height = 7)
...
ggsave(plot = figure_1C[[1]],filename = save_here(object_name = "Figure1C.pdf"),width = 10,height = 7)
ggsave(plot = figure_1C[[2]],filename = save_here(object_name = "Supplemental_Figure1C.pdf"),width = 10,height = 7)

figure1<-(figure_1A[[1]]+figure_1B[[1]])/figure_1C[[1]]+plot_annotation(tag_levels = "A")
suppfigure1<-(figure_1A[[2]]+figure_1B[[2]])/figure_1C[[2]]+plot_annotation(tag_levels = "A")

ggsave(plot = figure1,filename = save_here(object_name = "Figure1.pdf"),width = 15,height = 12)
ggsave(plot = suppfigure1,filename = save_here(object_name = "Supplemental_Figure1.pdf"),width = 15,height = 12)
