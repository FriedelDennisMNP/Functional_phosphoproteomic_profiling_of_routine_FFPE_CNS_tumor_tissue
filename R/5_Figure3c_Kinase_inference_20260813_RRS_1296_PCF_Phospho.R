...
ptm_se_imp <- readRDS(
  "./output/20260813_RRS_1296_PCF_Phospho/PTM_PRC_DEA/2026-09-07/ptm_se_imp.rds")

ttresult <- openxlsx::read.xlsx(
  "./output/20260813_RRS_1296_PCF_Phospho/PTM_PRC_DEA/2026-09-07/TopTable_WT_AMP.xlsx"
)
...
dataset = paste0('/Figures/')

ggsave(
  plot = hms[[1]],
  save_here(
    object_name = "Protmapper_Significant_Kinases_Activities.pdf",
    analysis = paste0('/', Sys.Date()),
    dataset_name = paste0('/Figure3c/')
  ),
  width = 12,
  height = 10
)
